...
class CreatePDF extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->addFields( [ MField::requiredLabel('Nome da Classe PDF') ], [ $descricao ] );
    ...
    public function onSave($param)
    {
        ...
        $form = file_get_contents(getcwd().'/app/control/lemarq/util/templates/TemplatePDF.php');
