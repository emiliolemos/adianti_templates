...
class MTPageNavigation
{
    ...
    {
        $this->page = (int) $this->action->getParameter('application').$page;
    }
    ...
    public function setProperties($properties)
    {
        ...
        $page       = isset($properties[$properties['application'] . 'page'])   ? $properties[$properties['application'] . 'page']   : 1;
    ...
    public function show()
    {
        ...
        if ($first_page > 1)
        {
            ...
            $this->action->setParameter($this->action->getParameter('application') . 'page',   1);
            ...
            $this->action->setParameter('limit',  $page_size);
            $this->action->setParameter('direction', $this->direction);
            $this->action->setParameter($this->action->getParameter('application') . 'page',   $first_page - $max);
        ...
        for ($n = $first_page; $n <= $last_page + $first_page -1; $n++)
        {
            ...
            $this->action->setParameter('limit',  $page_size);
            $this->action->setParameter('direction', $this->direction);
            $this->action->setParameter($this->action->getParameter('application') . 'page',   $n);
        ...
        if ($pages > $max)
        {
            ...
            $this->action->setParameter('limit',   $page_size);
            $this->action->setParameter('direction', $this->direction);
            $this->action->setParameter($this->action->getParameter('application') . 'page',    ceil($registros / $page_size));
